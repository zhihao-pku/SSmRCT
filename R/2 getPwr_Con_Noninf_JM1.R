...
#'   N = 400, r = 1, direct = 1, sim = F
#' )
#' dat1$M <- "calc"
#' dat2 <- getPwr_Con_Noninf_JM1(
#'   delta_j = -0.2, delta_nj = -0.1, sigma = 1,
#'   f = seq(0.1, 0.9, 0.1), pi = 0.5, cut = 0.4, alpha = 0.025,
#'   N = 400, r = 1, direct = 1, sim = T
#' )
#' dat2$M <- "sim"
#'
...
getPwr_Con_Noninf_JM1 <- function(delta_j, delta_nj, sigma, f, pi, cut, alpha, N, r, direct = 1, sim = F, nsim = 1000, seed = 0) {
  if (!sim) {
